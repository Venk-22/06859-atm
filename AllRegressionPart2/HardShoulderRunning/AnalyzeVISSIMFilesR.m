...
for runCount=1:20
    ...
    fileLocation=strcat(currentFolder,'\',num2str(runCount),'\dluchsr_003_Queue Results.att');
    if exist(fileLocation, 'file')==0
        %iteration 3 files do not exist so assign it as iteration 2 file
        fileLocation=strcat(currentFolder,'\',num2str(runCount),'\dluchsr_002_Queue Results.att');
    end
    if exist(fileLocation, 'file')==0
...
%     percentTimeQexceedsMainline = noOfTimeQexceedsMainline*3/count;
    ...
    fileLocation=strcat(currentFolder,'\',num2str(runCount),'\dluchsr_003_Vehicle Travel Time Results.att');
    if exist(fileLocation, 'file')==0
        %iteration 3 files do not exist so assign it as iteration 2 file
        fileLocation=strcat(currentFolder,'\',num2str(runCount),'\dluchsr_002_Vehicle Travel Time Results.att');
    end
    if exist(fileLocation, 'file')==0
        %even second iteration file doesn't exist
        display('No file found');
